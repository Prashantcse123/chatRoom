...
module.exports.logout=(req,res)=>{
    ...
    res.render('index',{"lgMsg":"Successfully Logout..."})
}
...
module.exports.signin=(req,res)=>{
    ...
    userModel.findOne({username:username},(err,doc)=>{
        ...
        if(doc.length!=0){
            ...
            if(valid){
              let token=jwt.sign({name:doc.name,username:doc.username,password:doc.password,email:doc.email},"systango@#$secret123",{ expiresIn: '1h' },{algorithm:'HS512'})
